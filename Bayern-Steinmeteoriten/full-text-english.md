...
These results deviate so considerably from those communicated earlier on that for this no other grounds can be found than the wide inequality in the composition of the meteoritic stones, which all the more expresses the greater level of importance of the findings of the examination, with one being obliged to work with ever smaller quantities.
