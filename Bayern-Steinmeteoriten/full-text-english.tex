...
\begin{titlepage} % Suppresses headers and footers on the title page
	...
	{\LARGE Proceedings of the\\[0.05in] Mathematics and Physical Class\\[0.05in] of the\\[0.05in] Royal Bavarian Academy\\[0.15in] of Sciences in Munich.}
...
\begin{enumerate}
    ...
    \item still other tiny kernels of a white and yellow color that are translucent and shimmering. According to his analysis, the meteoritic stone is comprised of:
\end{enumerate}
\begin{center}
    \begin{tabular}{l r} 
...
The specific weight\footnote{Compare with Moll's \emph{Annal, d. Berg- u. Hüttenk}. Vol. 3. p. 251.} is given:
\begin{center}
    \begin{tabular}{l r}
...
\end{center}
\paragraph{}
Klaproth has analyzed this stone and gives (Gilbert's \emph{Annals of Physics}. Vol. 13. p. 338) as its component parts:
\begin{center}
    \begin{tabular}{l r}
        Solid iron & 19.00\\
        Nickel metal & 1.50\\
...
\begin{center}
    \begin{tabular}{l r}
        ...
        Al\textsubscript{2}O\textsubscript{3} & 0.86 with 0.40\\
        FeO & 24.52 with 5.45\\
        MgO & 37.31 with 14.90\\
        CaO & 0.68 with 0.19\\
        Ka\textsubscript{2}O & 0.68 with 0.11\\
        Na\textsubscript{2}O & 1.31 with 0.34\\
    \end{tabular}
\end{center}
\paragraph{}
...
\begin{enumerate}
    \item Yellowish-green to light green, somewhat parallelly cracked, considerably large 1 --- 1.5 millimeters wide in diameter, rounded and irregular granules (as in crystalline form) that occur only sporadically as seemingly admixed pieces, which are easily disintegrated by acids and must be held as olivine.
    \item Of a white mineral, often transparent like glass or merely translucent like a dusty cloud, heavily cracked, seldomly with parallel stripes, furnished at times with clear cleavage surfaces that in polarized light come across as vivid single- or multi-colored patches, and that is also disintegrated by acids, in accordance with a feldspar.
    \item Of a wine yellow to greyish-green, or faintly reddish-brown, glass-like matte polished mineral, 1.5 to 2 millimeters large, colored vividly in polarized light, though not dichroic, some longitudinal fibers (but unclear, striated) and suffused with abundant small bubbles. These component parts are not decomposed by acids and belong to the augite group.
    \item Of black, intensely shiny chromite, not decomposable in acids, which yielded a magnificent green glass in the phosphate test.
...
\begin{enumerate}
    \item larger, greenish-yellow bits, decomposable by the use of hydrochloric acid, give a solution containing a lot of ferrous oxide and magnesia --- also olivine-like,
...
I encountered partially similar views, to which my study of the chondrites led, even with Sorby, who in the past had already indicated this in the essay: ``On the Physical History of Meteorites.''\footnote{\emph{The Geological Magazine}, 2. 1865. p. 447.}
