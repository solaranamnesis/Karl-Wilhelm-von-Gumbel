...
Auch verschiedene Gasarten sind bereits durch Wriht[^9] in diesem Meteorit von Iowa nachgewiesen. Die vorläufigen Versuche Wriht's ergaben einen Gehalt an Gas, welches fast zur Hälfte aus Kohlensäure und Kohlenoxyd (CO<sub>2</sub> = 35; CO = 14), im Übrigen hauptsächlich aus Wasserstoff besteht.
...
Der in Salzsäure zersetzbare Teil[^10] (ohne Meteor-und Schwefeleisen berechnet) aus
...
Unter den bisher analysierten Chondriten ist nur jener von Tadjera von einer ähnlichen Zusammensetzung[^11], jedoch kieselsäureärmer und kalkreichen.
